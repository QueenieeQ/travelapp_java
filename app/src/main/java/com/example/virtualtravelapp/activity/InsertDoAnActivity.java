...
public class InsertDoAnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThoat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InsertDoAnActivity.this, AdminDiaDanhActivity.class));
            }
        });
    }
    ...
    private void InsertDiaDanh() {
        ...
        if (name == "" || image == "" || imageDetail1 == "" || imageDetail2 == "" ||
            ...
            Toast.makeText(InsertDoAnActivity.this, "Chưa điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            if (result == 1) {
                Toast.makeText(InsertDoAnActivity.this, "Thêm thành công", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(InsertDoAnActivity.this, AdminDiaDanhActivity.class));
            }
            else {
                Toast.makeText(InsertDoAnActivity.this, "Thêm thất bại", Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
