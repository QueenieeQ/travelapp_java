...
public class AdminPhuongTienActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Quản lý phương tiện di chuyển trong tour");
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminPhuongTienActivity.this, InsertDoAnActivity.class);
