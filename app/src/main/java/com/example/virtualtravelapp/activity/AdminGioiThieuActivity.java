...
import com.example.virtualtravelapp.adapter.AdminGioiThieuAdapter;

import java.util.ArrayList;

public class AdminGioiThieuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Quản lý giới thiệu về tour");
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminGioiThieuActivity.this, InsertDoAnActivity.class);
